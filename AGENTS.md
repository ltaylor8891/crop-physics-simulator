...
- **Verify before finishing**: run `npm run typecheck`, `npm run lint`, `npm run test`, and `npm run build` before declaring work complete. Report any failures honestly rather than hiding them.
